        ...
        <div className="relative container text-center text-white z-10">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold font-playfair leading-tight">
              Craft Your
              <span className="bg-[linear-gradient(135deg,#6633B9,#F26646)] bg-clip-text text-transparent">
                Perfect
              </span>
              Step
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Design premium custom shoes that reflect your unique style. From
              concept to creation, every detail is crafted just for you.
            </p>
            <div
